...
define ['flight/lib/component',
  ...
  (defineComponent, extensions, Address, withi18n, withValidation, template) ->
    AddressSearch = ->
      ...
      @isMobile = ->
        # return (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Windows Phone|WPDesktop|Opera Mini/i.test(navigator.userAgent or navigator.vendor or window.opera))
        a = navigator.userAgent or navigator.vendor or window.opera
